...
> New capability of change `estados-reversion-realtime` — live estado/cliente/fecha_entrega updates via Supabase Realtime `postgres_changes`. No canonical spec exists for this domain; this is a full spec.
...
### Requirement: R1 — Publication membership for state tables [New]
...
### Requirement: R2 — Detail-page live updates [New]
...
### Requirement: R3 — Kanban live updates [New]
...
### Requirement: R4 — Role coverage for authenticated users [New]
