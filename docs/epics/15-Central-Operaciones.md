...
> **Siguiente**: —  
> **Archivado**: — (pendiente; 5 changes SDD encadenados: `central-op-fase1-schema` → `central-op-fase2-tokens` → `central-op-fase3-vista-movil` → `central-op-fase4-kanban-desktop` → `central-op-fase5-realtime-whatsapp-ficha`)
